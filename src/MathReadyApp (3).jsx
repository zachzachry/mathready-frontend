...
const QUESTIONS = [
  { id:"q001", standard:"5.NR.1.1", short:"Place Value",       question:"In the number 3,492, the digit 4 is in the hundreds place. What is the value of the digit 4?", choices:["4","40","400","4,000"], correct:"400" },
  { id:"q002", standard:"5.NR.1.2", short:"Powers of 10",      question:"What is 4.7 × 10²?", choices:["0.047","47","470","4,700"], correct:"470" },
  { id:"q003", standard:"5.NR.2.2", short:"Division",          question:"A school bought 144 pencils to share equally among 12 classrooms. How many pencils does each classroom get?", choices:["10","11","12","13"], correct:"12" },
  { id:"q004", standard:"5.NR.3.3",  short:"Add Fractions",     question:"What is 1/4 + 1/2?", choices:["2/6","1/3","3/4","2/4"], correct:"3/4" },
  { id:"q005", standard:"5.NR.3.4",  short:"Multiply Fractions",question:"A recipe calls for 2/3 cup of sugar. If you make 3 batches, how much sugar do you need in all?", choices:["2/9 cup","1 cup","2 cups","6 cups"], correct:"2 cups" },
  { id:"q006", standard:"5.NR.3.6",  short:"Divide Fractions",  question:"You have 4 yards of ribbon. You cut it into pieces that are each 1/2 yard long. How many pieces do you get?", choices:["2","4","6","8"], correct:"8" },
  { id:"q007", standard:"5.NR.5.1",  short:"Order of Ops",      question:"What is the value of (3 + 5) × 2 − 4?", choices:["6","12","14","20"], correct:"12" },
  { id:"q008", standard:"5.MDR.7.4",  short:"Unit Conversion",   question:"A table is 2 meters long. How many centimeters long is the table?", choices:["2","20","200","2,000"], correct:"200" },
  { id:"q009", standard:"5.GSR.8.3",  short:"Volume",            question:"A rectangular box is 4 cm long, 3 cm wide, and 2 cm tall. What is its volume?", choices:["9 cubic cm","14 cubic cm","18 cubic cm","24 cubic cm"], correct:"24 cubic cm" },
  { id:"q010", standard:"5.GSR.8.1",   short:"Geometry",          question:"Which shape ALWAYS has 4 right angles and 4 equal sides?", choices:["Rectangle","Rhombus","Square","Trapezoid"], correct:"Square" },
];
